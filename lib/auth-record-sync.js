...
function create(alephRecordService, alephFindService, options) {
  ...
  async function handleAuthChange(change) {
    ...
    logger.log('info', `[${changeId}] Handled bibs linked to ${change.recordId}: BibCount: ${bibCount}. bibNoChanges: ${bibNoChanges}, bibChanges: ${bibChanges}, bibSaves: ${bibSaves}, bibErrors ${bibErrors}, bibNoOps: ${bibNoOps}, bibRecents: ${bibRecents}`);

...
function create(alephRecordService, alephFindService, options) {
  ...
  async function handleAuthChange(change) {
    ...
    logger.info(`[${changeId}] Handled bibs linked to ${change.recordId}: BibCount: ${bibCount}. bibNoChanges: ${bibNoChanges}, bibChanges: ${bibChanges}, bibSaves: ${bibSaves}, bibErrors ${bibErrors}, bibNoOps: ${bibNoOps}`);
    ...
    logger.info(`[${changeId}] Handled linkedAgents linked to ${change.recordId}: linkedAgentCount: ${linkedAgentCount}. linkedAgentNoChanges: ${linkedAgentNoChanges}, linkedAgentChanges: ${linkedAgentChanges}, linkedAgentSaves: ${linkedAgentSaves}, linkedAgentErrors ${linkedAgentErrors}, linkedAgentNoOps: ${linkedAgentNoOps}`);
  }

  ...
  describe('findAuthorizedPortion', () => {
    ...
    describe('for BIB records', () => {
      ...
      it('should not pick non-authorized subfields into the authorized portion ($e, $9)', () => {
        const authorityRecordField = RecordUtils.stringToField('100 0  ‡aNimi,‡d1922-1999,‡etoimittaja');
  ...
  describe('updateAuthorizedPortion', () => {
    ...
    describe('for BIB records', () => {
      ...
      it('should make a copy of the authorizedPortion', () => {
        ...
        const authorityRecordField = RecordUtils.stringToField('100    ‡aAakkula, Immo');
        const bibRecordField = RecordUtils.stringToField('100    ‡aAakkula, I,‡etestaaja.‡0(TST10)90001');

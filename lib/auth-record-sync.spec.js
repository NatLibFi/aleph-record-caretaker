...
describe('AuthRecordSyncService', () => {
  ...
  beforeEach(() => {
    ...
    findServiceStub = {
      findRecordsLinkedToAgentRecords: sinon.stub()
    };

    findServiceStub.findRecordsLinkedToAgentRecords.resolves([]);
  ...
  describe('for linked bib records', () => {
    ...
    beforeEach(() => {
      ...
      findServiceStub.findRecordsLinkedToAgentRecords.withArgs('TST01', '90001').resolves(['00001']);
    });
    ...
    // DEVELOP: Two different identifiers to same base should error
    // We handle this in bib-record-sync, but not here ...
    ...
    it('should handle multiple records', async () => {
      ...
      findServiceStub.findRecordsLinkedToAgentRecords.withArgs('TST01', '90001').resolves(['00001', '00002']);
    ...
    // Skip test as new punctuation rules will not error unknown subfield codes, so this test is no longer working
    // DEVELOP: find out how to error a record with new punctuation rules, so that this test can be re-enabled
    it.skip('should not stop when one of the records fail', async () => {
      ...
      // Guess newer punctuation rules won't error unknown subfield codes?
      ...
      recordServiceStub.loadRecord.withArgs('TST10', '90001').resolves(fakeAuthRecord);
      findServiceStub.findRecordsLinkedToAgentRecords.withArgs('TST01', '90001').resolves(['00001', '00002', '00003']);
  ...
  describe('for linked auth records', () => {
    ...
    beforeEach(() => {
      ...
      recordServiceStub.loadRecord.withArgs('TST10', '90001').resolves(fakeAuthRecord);
      findServiceStub.findRecordsLinkedToAgentRecords.withArgs('TST10', '90001').resolves(['00001']);
      findServiceStub.findRecordsLinkedToAgentRecords.withArgs('TST01', '90001').resolves([]);

...
function parseZ106Row(row, base = '???') {
  ...
  return {
    ...
    // Z106 has 1 minute resolution: pad the time to 4 characters (HHmm) and append 0000 to form HHmmssSS
    date: utils.parseDate(Z106_UPDATE_DATE, _.padStart(String(Z106_TIME), 4, '0') + '0000'),

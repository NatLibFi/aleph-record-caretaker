...
function create(X_SERVER) {
  async function findLinkedToAgentBibRecords(authorityRecordId) {
    return findRecordsLinkedToAgentRecords('fin01', authorityRecordId);
  }
  async function findLinkedToSubjectBibRecords(authorityRecordId) {
    return findRecordsLinkedToSubjectRecords('fin01', authorityRecordId);
  }
  async function findRecordsLinkedToAgentRecords(base, authorityRecordId) {
  ...
  async function findRecordsLinkedToSubjectRecords(base, authorityRecordId) {
    const normalizedRecordId = _.padStart(authorityRecordId, 9, '0');
  ...
  return {
    ...
    findRecordsLinkedToAgentRecords,
    findRecordsLinkedToSubjectRecords,
    queryIndex
  };
}
module.exports = {
